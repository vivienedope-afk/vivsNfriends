  ...
  <main>
    ...
    <div class="card">
      ...
      <div class="card-content" style="padding: 40px; text-align: center;">
        ...
        <h3 style="color: #6c757d; margin-bottom: 10px;">Facility Bookings Module</h3>
        <p style="color: #868e96; font-size: 14px; line-height: 1.6;">
          This page will contain:<br>
          • Booking requests management<br>
          • Approve/reject facility reservations<br>
          • Booking calendar view<br>
          • Facility availability tracking<br>
